...
export const Contact: React.FC<ContactProps> = ({ lang }) => {
  ...
  const content = {
    es: {
      ...
      options: {
        essence: "Plan Essence (Landing Page) - Desde 350€",
        identity: "Plan Identity (Web Corporativa) - Desde 900€",
        ecosystem: "Plan Ecosystem (E-commerce / App) - Desde 1.500€",
    ...
    en: {
      ...
      options: {
        essence: "Essence Plan (Landing Page) - From 350€",
        identity: "Identity Plan (Corporate Web) - From 900€",
        ecosystem: "Ecosystem Plan (E-commerce / App) - From 1.500€",
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-12">
              ...
              <div className="pt-4 flex justify-center">
                <button
                  ...
                  className={`group w-full max-w-xs py-4 flex items-center justify-center gap-2 text-xs uppercase tracking-widest font-bold transition-all duration-300 ${status === 'sending' || status === 'success' ? 'bg-emerald-500 text-white' :
